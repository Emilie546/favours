...
file = URI.open('https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=668&q=80')
emilie = User.new(email: 'emilie@favours.com', password: "123456", first_name: 'Emilie' , last_name: 'Keller', location: 'N/A', phone_number: Faker::PhoneNumber.cell_phone )
emilie.profile_picture.attach(io: file, filename: 'nes.jpeg', content_type: 'image/jpeg')
emilie.save!

file_1 = URI.open('https://images.unsplash.com/photo-1505503693641-1926193e8d57?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=668&q=80')
hugo = User.new(email: 'hugo.mori@outlook.com', password: "123456", first_name: 'Hugo' , last_name: 'Mori', location: 'Route du Jorat 82, 1000 Lausanne 26', phone_number: Faker::PhoneNumber.cell_phone )
...
file_3 = URI.open('https://images.unsplash.com/photo-1526080652727-5b77f74eacd2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1355&q=80')
anais = User.new(email: 'anais@me.com', password: "123456", first_name: 'Anais' , last_name: 'Minal', location: 'Rue Marterey 29, 1005 Lausanne', phone_number: Faker::PhoneNumber.cell_phone )
...
file_6 = URI.open('https://images.unsplash.com/photo-1520998116484-6eeb2f72b5b9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60')
justine = User.new(email: 'justine.del@hotmail.com', password: "123456", first_name: 'Justine' , last_name: 'De la Cour', location: 'Rue de Genève 23, 1003 Lausanne', phone_number: Faker::PhoneNumber.cell_phone )
justine.profile_picture.attach(io: file_6, filename: 'nes.jpeg', content_type: 'image/jpeg')
justine.save!

file_7 = URI.open('https://images.unsplash.com/photo-1525545073321-a0c3bc5f4c1b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=668&q=80')
kim = User.new(email: 'kim@k.ch', password: "123456", first_name: 'Kim' , last_name: 'Kardashian', location: 'Rue de Crissier 4b, 1020 Renens', phone_number: Faker::PhoneNumber.cell_phone )
kim.profile_picture.attach(io: file_7, filename: 'nes.jpeg', content_type: 'image/jpeg')
kim.save!

file_8 = URI.open('https://images.unsplash.com/photo-1534399315465-2b91232de345?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60')
james = User.new(email: 'james@yahoo.com', password: "123456", first_name: 'James' , last_name: 'Bond', location: 'Place du Sauget 8, 1026 Echandens', phone_number: Faker::PhoneNumber.cell_phone )
...
Favour.create!(name: 'Golden Retriever', description: 'Golden retriever needs a walk every monday', category: dog_walk, user: james, start_time: Faker::Time.forward, end_time: Faker::Time.forward,  latitude: 46.5089513, longitude: 6.6582343, price_cents: Faker::Number.number(digits: 2))
sleep 1
Favour.create!(name: 'Baby-Sitting', description: 'Urgent', category: kids, user: kim, start_time: Faker::Time.forward, end_time: Faker::Time.forward, latitude: 46.5026119, longitude: 6.6832795, price_cents: Faker::Number.number(digits: 2))
sleep 1
Favour.create!(name: 'Flower needs planting', description: 'I need some gardenias planted', category: garden, user: justine, start_time: Faker::Time.forward, end_time: Faker::Time.forward,  latitude: 46.3197734, longitude: 6.194338, price_cents: Faker::Number.number(digits: 2))
sleep 1
Favour.create!(name: 'Help needed', description: 'Can someone ride my horse, Lolita this week', category: horse, user: georgina, start_time: Faker::Time.forward, end_time: Faker::Time.forward,  latitude: 46.508433, longitude: 6.6278714, price_cents: Faker::Number.number(digits: 2))
sleep 1
Favour.create!(name: 'Lonely Kitten', description: 'Help! Lonely kitty needs company', category: cat, user: florian, start_time: Faker::Time.forward, end_time: Faker::Time.forward,  latitude: 46.5194027 , longitude: 6.6285312, price_cents: Faker::Number.number(digits: 2))
sleep 1
Favour.create!(name: 'Wild prairie', description: 'Lawn mower wanted', category: garden, user: etienne, start_time: Faker::Time.forward, end_time: Faker::Time.forward,  latitude: 46.5324247, longitude: 6.5889239, price_cents: Faker::Number.number(digits: 2))
sleep 1
Favour.create!(name: 'Ride to GVA', description: 'Looking for someone to share the ride', category: car, user: anais, start_time: Faker::Time.forward, end_time: Faker::Time.forward,  latitude: 46.5167587, longitude:  6.564989, price_cents: Faker::Number.number(digits: 2))
sleep 1
Favour.create!(name: 'Need to find day home for puppy', description: 'Little Dachshund needs to be kept while at work', category: dog_walk, user: hugo, start_time: Faker::Time.forward, end_time: Faker::Time.forward,  latitude: 46.5484919, longitude: 6.671373, price_cents: Faker::Number.number(digits: 2))
sleep 1
Favour.create!(name: 'Triplets', description: 'Help...', category: kids, user: emilie, start_time: Faker::Time.forward, end_time: Faker::Time.forward,  latitude: 46.5008672, longitude: 6.692892, price_cents: Faker::Number.number(digits: 2))
sleep 1
...
sleep 1
Favour.create!(name: 'Website creation', description: 'Can someone help me with a new website for my flower-store?', category: it, user: justine, start_time: Faker::Time.forward, end_time: Faker::Time.forward,  latitude: 46.5154453, longitude: 6.5458986, price_cents: Faker::Number.number(digits: 2))
sleep 1
Favour.create!(name: 'Printer Set-up', description: 'Lost in a sea of cables behind my desk - help me', category: it, user: florian, start_time: Faker::Time.forward, end_time: Faker::Time.forward,  latitude: 46.5173601, longitude: 6.477526, price_cents: Faker::Number.number(digits: 2))
sleep 1
Favour.create!(name: 'German tutor wanted', description: 'For my son, 14ys', category: devoirs, user: etienne, start_time: Faker::Time.forward, end_time: Faker::Time.forward, latitude: 46.3932958, longitude: 6.2549891, price_cents: Faker::Number.number(digits: 2))
sleep 1
Favour.create!(name: 'Help with homework', description: 'Need help understanding my geometry homework', category: devoirs, user: georgina, start_time: Faker::Time.forward, end_time: Faker::Time.forward,  latitude: 46.2667355, longitude: 6.1574039, price_cents: Faker::Number.number(digits: 2))
sleep 1
Favour.create!(name: 'Cinema Opening', description: 'Can someone stand in line for me? Min 3 hours', category: other, user: emilie, start_time: Faker::Time.forward, end_time: Faker::Time.forward,  latitude: 46.3475617 , longitude: 6.1836419, price_cents: Faker::Number.number(digits: 2))
sleep 1
Favour.create!(name: 'Sock pick-up', description: 'Locked in bed - need someone to pick my stuff off the floor', category: other, user: kim, start_time: Faker::Time.forward, end_time: Faker::Time.forward,  latitude: 46.2879653, longitude: 6.1596503, price_cents: Faker::Number.number(digits: 2))
sleep 1
Favour.create!(name: 'Video-game oponent', description: 'Mario Kart', category: other, user: james, start_time: Faker::Time.forward, end_time: Faker::Time.forward, latitude: 46.319367 , longitude: 6.1853344, price_cents: Faker::Number.number(digits: 2))
sleep 1
puts 'Finished!'
